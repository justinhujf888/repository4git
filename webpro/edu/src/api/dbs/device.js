...
export default {
    ...
    updateTheDeviceScript(deviceScript, onfun) {
        Http.httpclient_json(
            '/r/device/updateTheDeviceScript',
            'post',
