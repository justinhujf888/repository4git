<template>
    ...
    >
        <div class="mx-6 md:mx-20 mt-0 md:mt-6">
            <h1 class="text-6xl font-bold text-gray-900 leading-tight"><span class="font-light block">启航学习之旅</span>eget magna fermentum</h1>
            ...
            <Button label="我要参赛" as="router-link" to="/manage/index" rounded class="!text-base mt-8 !px-8 !py-3"></Button>
        </div>
