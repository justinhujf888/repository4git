...
<!--                :step-duration="0.8"-->
<!--            />-->
            <h2 class="text-center">每件作品都是一首生命的赞歌</h2>
            <h1 class="font-normal leading-normal text-center">{{Config.appName}} {{siteDatas?.cptInfo.masterCompetitionInfo.name}}</h1>
            <h5 class="text-center">{{siteDatas?.cptInfo.masterCompetitionInfo.tempMap.beginDate}} — {{siteDatas?.cptInfo.masterCompetitionInfo.tempMap.endDate}}</h5>
