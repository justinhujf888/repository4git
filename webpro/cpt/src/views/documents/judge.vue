<template>
    <div>
        <div v-for="(pageEls,i) in judgeDatas" :key="i" :class="{'mt-20':i>0}">
            <div v-for="element of pageEls.setup" class="mt-8" :class="{'_md:_px-20 _lg:_px-32':element.type!='image'}">
                                        ...
                                        <div v-for="item of slotProps.items" class="row">
                                            <div class="flex flex-col p-3 gap-4">
                                                <div class="relative w-full pb-5 px-5" style="max-width: 35rem;max-height: 35rem;width: 25rem;height: 30rem">
                                                    ...
                                                    <div class="absolute bottom-0 left-0 col gap-2 font-medium w-full p-5 text-white opacity-90 judge-card-foot-bg">
                                                        ...
                                                        <div>
                                                            <span class="text-lg mr-2">{{item.zhiWei}}</span>
