...
//    }
    ...
    String delImgFormOss(@RequestBody Map<String,Object> query)
    {
        try
        {
            ...
            ossClient.deleteObject(aliyunStsFactory.ganAliYunStsValue(query.appId as String,"ali_oss_bucketName"), query.imgPath as String);
            ossClient.shutdown();
            //oss end
            return """{"status":"OK"}""";
        }
