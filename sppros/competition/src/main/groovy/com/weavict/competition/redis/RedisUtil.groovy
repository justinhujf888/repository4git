package com.weavict.competition.redis
...
class RedisUtil {
     ...
     * @return
     */
    Cursor<Entry<Object, Object>> hScan(String key, ScanOptions options) {
     ...
     * @return
     */
    String lBRightPopAndLeftPush(String sourceKey, String destinationKey,
     ...
     * @return
     */
    Set<TypedTuple<String>> zRangeWithScores(String key, long start,
                                                    long end) {
     ...
     * @return
     */
    Set<TypedTuple<String>> zRangeByScoreWithScores(String key,
     ...
     * @return
     */
    Set<TypedTuple<String>> zReverseRangeWithScores(String key,
                                                           long start, long end) {
     ...
     * @return
     */
    Set<TypedTuple<String>> zReverseRangeByScoreWithScores(
