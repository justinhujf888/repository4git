...
class CorsFilter implements ContainerResponseFilter {
    void filter(ContainerRequestContext request, ContainerResponseContext c) throws IOException {
        ...
        if (request.getHeaderString("origin") in ["http://localhost:5173","https://localhost:5173","https://192.168.64.1:5173","https://image.arkydesign.cn","https://cpt.arkydesign.cn"])
        {
