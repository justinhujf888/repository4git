 ...
 */
    ...
    static uploadFile(HttpServletRequest request,String filePath,boolean useOld,Closure fun)
    {
        InputStream is = request.getInputStream();
        StringBuffer sb = new StringBuffer();
        int count = 0;
...
//        }
        ...
        fun.call(fileName,filePathName,jm);
    }

    static uploadFile(HttpServletRequest request,boolean useOld,Closure fun)
    {
        InputStream is = request.getInputStream();
        StringBuffer sb = new StringBuffer();
        int count = 0;
