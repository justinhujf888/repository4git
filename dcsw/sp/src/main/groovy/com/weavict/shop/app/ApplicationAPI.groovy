...
import com.weavict.shop.rest.OrderRest
import com.weavict.shop.rest.OtherRest
import com.weavict.shop.rest.PayRest
import com.weavict.shop.rest.PetRest
import com.weavict.shop.rest.ProductsRest
import com.weavict.shop.rest.QuestionnaireRest
import com.weavict.shop.rest.RequestClientWriterInterceptor
import com.weavict.shop.rest.RequestServerReaderInterceptor
import com.weavict.shop.rest.TwiterRest
import com.weavict.shop.rest.UploadRest
import com.weavict.shop.rest.UserRest
import com.weavict.shop.rest.WxRest
...
class ApplicationAPI extends ResourceConfig
{
    ApplicationAPI() {
        ...
        register(TwiterRest.class);
        register(ProductsRest.class);
        register(OrderRest.class);
        register(PayRest.class);
        register(PetRest.class);
        register(QuestionnaireRest.class);
