...
class OtherUtils
{
	...
	static Props giveTheProps()
	{
		try
		{
			...
			{
				props = new Props();
//				props.load(new File(ClassLoaderUtil.getResourceUrl("/config/global.props").getPath()));
	...
	static Map genOssAccessKey(String ramUser)
	{
		...
		{
			case "blogs":
				return ["accessId":"LTAI4FuAWWnN361gV8XWLxYa","accessKey":"urUpRatlYMKt2JHh0qJj56BM6mYSCd"];
				break;
			case "privater":
				return ["accessId":"LTAI4FjpyyWxThbxGH1cwbjA","accessKey":"5evfC78QZyVYUqpAgwFDIrGEkcCxbS"];
				break;
			case "ross":
				return ["accessId":"LTAI4FvFdnUYiB5gEBPq1GyA","accessKey":"HlO2KblgbEVdtKUJiSy4ugIvCbrfsV"];
				break;
			default:
				return null;
		}
